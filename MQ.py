...
class MQ():
    ...
    RL_VALUE                     = 19        # define the load resistance on the board, in kilo ohms
    RO_CLEAN_AIR_FACTOR          = 3.59     # RO_CLEAR_AIR_FACTOR=(Sensor resistance in clean air)/RO,
    ...
    READ_SAMPLE_TIMES            = 50       # define the time interval(in milisecond) between each samples in 
                                            # normal operation
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.CO2Curve = [1, 0.38,-0.366]    # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent"
                                            # to the original curve. 
                                            # data format:[ x, y, slope]; point1: (lg10, lg2.4), point2: (lg200, lg0.8) 

        self.NH3Curve = [1, 0.415,-0.415]   # two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg10, lg2.6), point2: (lg100,  lg1)

        self.SmokeCurve = [1,0.1761,-0.3735]# two points are taken from the curve. 
                                            # with these two points, a line is formed which is "approximately equivalent" 
                                            # to the original curve.
                                            # data format:[ x, y, slope]; point1: (lg10, lg1.5), point2: (lg200,  lg0.49)  
